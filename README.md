...
- 🌐 **Simpler multi-repo PRs** — search across every cached repo and spin up writable workspaces on demand, so your agent can author PRs across multiple repos in a single session with ease.
