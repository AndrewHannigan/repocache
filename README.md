...
- 🌐 **Simpler multi-repo PRs** — search across every cached repo and spin up writable workspaces on demand, making it easier for your agent to author PRs across multiple repos in a single session.
